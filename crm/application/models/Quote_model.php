...
class Quote_model extends CI_Model
{
    ...
    public function quote_details($id)
    {
        ...
        $this->db->select('geopos_quotes.*,geopos_customers.*,geopos_customers.id AS cid,geopos_terms.id AS termid,geopos_terms.title AS termtit,geopos_terms.terms AS terms');
        $this->db->from($this->table);
        $this->db->where('geopos_quotes.tid', $id);
