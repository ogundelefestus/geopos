...
<head>
    ...
    <title>Print Invoice # {invoice_id} ?></title>
    <style>
        body {
            color: #2B2000;
...
<div class="invoice-box">
    ...
    <table class="party">
        ...
        <tbody>
        <tr>
            <td><strong>{Company_Name}</strong><br>

                {Company_Address} <br>{Company_City} , {Company_Region} <br> {Company_Country} - {Company_PosBox} <br>
                {Text_Phone} : {Company_Phone} .<br> ' . $this->lang->line('Email') . : {Company_Email}
